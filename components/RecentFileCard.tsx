...
export const RecentFileCard: React.FC<RecentFileCardProps> = ({ file, delay, moduleName, onNavigate }) => {
  const displayModuleName = moduleName || file.moduleCode;
  return (
    <div 
    ...
    >
      ...
      <div className="flex-grow relative z-10">
        <h4 className="text-[12px] font-bold text-slate-400 dark:text-white/30 uppercase tracking-[0.1em] mb-3 line-clamp-1">{displayModuleName}</h4>
